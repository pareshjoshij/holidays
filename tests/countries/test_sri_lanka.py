...
class TestSriLanka(CommonCountryTests, TestCase):
    ...
    def test_l10n_hi(self):
        self.assertLocalizedHolidays(
            "hi",
            ("2022-01-14", "तमिल थाई पोंगल दिवस"),
            ("2022-01-17", "दुरूतू पूर्णिमा पोया"),
            ("2022-02-04", "स्वतंत्रता दिवस"),
            ("2022-02-16", "नवम पूर्णिमा पोया"),
            ("2022-03-01", "महा शिवरात्रि"),
            ("2022-03-17", "मेदिन पूर्णिमा पोया"),
            ("2022-04-11", "विशेष सार्वजनिक अवकाश"),
            ("2022-04-12", "विशेष सार्वजनिक अवकाश"),
            ("2022-04-13", "सिंहल और तमिल नव वर्ष से पूर्व का दिन"),
            ("2022-04-14", "सिंहल और तमिल नव वर्ष"),
            ("2022-04-15", "गुड फ्राइडे"),
            ("2022-04-16", "बक पूर्णिमा पोया"),
            ("2022-05-01", "अंतर्राष्ट्रीय श्रमिक दिवस"),
            ("2022-05-02", "विशेष सार्वजनिक अवकाश"),
            ("2022-05-03", "ईद-उल-फितर"),
            ("2022-05-15", "वेसाक पूर्णिमा पोया"),
            ("2022-05-16", "वेसाक पूर्णिमा पोया के बाद का दिन"),
            ("2022-06-13", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-06-14", "पोसोन पूर्णिमा पोया"),
            ("2022-06-17", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-06-24", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-07-01", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-07-08", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-07-10", "ईद-उल-अज़हा"),
            ("2022-07-13", "एसाला पूर्णिमा पोया"),
            ("2022-07-15", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-07-22", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-07-29", "सार्वजनिक क्षेत्र का अवकाश"),
            ("2022-08-11", "निकिनी पूर्णिमा पोया"),
            ("2022-09-10", "बिनारा पूर्णिमा पोया"),
            ("2022-10-09", "पैगंबर का जन्मदिन (मिलाद-उन-नबी); वप पूर्णिमा पोया"),
            ("2022-10-10", "विशेष बैंक अवकाश"),
            ("2022-10-24", "दीपावली त्योहार"),
            ("2022-11-07", "इल पूर्णिमा पोया"),
            ("2022-12-07", "उंदुवप पूर्णिमा पोया"),
            ("2022-12-25", "क्रिसमस दिवस"),
            ("2022-12-26", "विशेष बैंक अवकाश"),
        )
